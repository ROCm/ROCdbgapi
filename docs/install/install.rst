.. meta::
   :description: Installation instructions for ROCdbgapi
...
For advanced workflows, source builds, or custom configurations, see `Build the
AMD Debugger API library
<https://github.com/ROCm/rocm-systems/blob/develop/projects/rocdbgapi/README.md#build-the-amd-debugger-api-library>`__.
...
Alternatively, if you want to install ROCdbgapi as part of the ROCm
...
nightly builds for the ROCm Core SDK and its components, including ROCdbgapi.
